      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Section title="Appearance">
            <SettingRow label="Theme" description="Choose how TokyoOS looks">
          ...
          <Section title="Speech">
            ...
            {!speechBackendAvailable && speechBackendAvailable !== null && (
              <div className="text-xs mt-2 px-1" style={{ color: 'var(--color-text-tertiary)' }}>
                ...
                See the <a href="https://open-jarvis.github.io/TokyoOS/user-guide/tools/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-accent)' }}>documentation</a> for details.
              </div>
            )}
          </Section>
          ...
          <Section title="About">
            <div className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
              <p className="mb-2">
                <span className="font-semibold" style={{ color: 'var(--color-text)' }}>TokyoOS</span> — Programming abstractions for on-device AI.
              </p>
              ...
              <div className="flex gap-3 mt-3 text-xs">
                ...
                <a
                  href="https://open-jarvis.github.io/TokyoOS/"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: 'var(--color-accent)' }}
                >

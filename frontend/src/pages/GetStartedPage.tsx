...
const GITHUB_BASE =
  'https://github.com/open-jarvis/TokyoOS/releases/latest/download';
    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <Section icon={Terminal} title="Command Line (macOS / Linux)" defaultOpen>
          ...
          <CodeBlock code={"git clone https://github.com/open-jarvis/TokyoOS.git\ncd TokyoOS\nuv sync"} />

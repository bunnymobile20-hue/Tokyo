...
export function Sidebar() {
  ...
  const navItems = [
    { path: '/', icon: MessageSquare, label: 'Visão Geral (Chat)' },
    { path: '/agents', icon: Bot, label: 'Funcionários IA' },
    { path: '/data-sources', icon: Database, label: 'Memory & Workflows' },
    { path: '/desktop-agent', icon: Laptop, label: 'MacBook Agent' },
    { path: '/logs', icon: ScrollText, label: 'Logs' },
    { path: '/settings', icon: Settings, label: 'Settings (Doctor)' },
  ];
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full w-[260px]">
          ...
          {/* TokyoOS Shell Branding */}
          <div className="px-3 mb-4 flex flex-col gap-1">
            <h1 className="font-bold text-lg" style={{ color: 'var(--color-accent)' }}>TokyoOS</h1>
            <div className="text-xs font-semibold" style={{ color: 'var(--color-text)' }}>GrupsBunny Command Center</div>
            <div className="text-[10px]" style={{ color: 'var(--color-text-tertiary)' }}>Powered by TokyoOS + OpenJarvis Core</div>
            
            <div className="flex flex-wrap gap-1 mt-2">
              <span className="px-1.5 py-0.5 text-[9px] rounded bg-green-900/40 text-green-400 border border-green-500/30">ZimaOS Online</span>
              <span className="px-1.5 py-0.5 text-[9px] rounded bg-blue-900/40 text-blue-400 border border-blue-500/30">Porta 8788</span>
              <span className="px-1.5 py-0.5 text-[9px] rounded bg-purple-900/40 text-purple-400 border border-purple-500/30">SafetyGate ativo</span>
              <span className="px-1.5 py-0.5 text-[9px] rounded bg-red-900/40 text-red-400 border border-red-500/30">Zero Mock Gate ativo</span>
            </div>
          </div>
